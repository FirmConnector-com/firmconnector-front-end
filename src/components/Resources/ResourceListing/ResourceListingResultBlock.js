                        ...
                        <div key={index.toString()} className="d-block mb-3">
                            <div className="card-custom">
                                <div className="card-body">
                                    <div
                                        className="d-block d-md-flex d-lg-flex d-xl-flex d-xxl-flex row align-items-center">
                                        <div
                                            className="col-12 col-lg-1 col-xl-1 col-xxl-1 mb-3 mb-lg-0 mb-xl-0 mb-xxl-0">
                                            <Link to={"resources/details/" + item.user_slug}>
                                                <ProfileImageMd imgSrc={item.profile_image_path}/>
                                            </Link>
                                        </div>
                                        <div
                                            className="col-12 col-lg-3 col-xl-3 col-xxl-3 mb-3 mb-lg-0 mb-xl-0 mb-xxl-0">
                                        ...
                                        <div
                                            className="col-12 col-lg-2 col-xl-2 col-xxl-2 mb-3 mb-lg-0 mb-xl-0 mb-xxl-0">
                                            {user_primary_role === "2" ? (
                                        ...
                                        <div
                                            className="col-12 col-lg-1 col-xl-1 col-xxl-1 mb-3 mb-lg-0 mb-xl-0 mb-xxl-0 d-flex flex-column align-items-start align-items-lg-center align-items-xl-center align-items-xxl-center">
                                        ...
                                        <div
                                            className="col-12 col-lg-3 col-xl-3 col-xxl-3 d-flex justify-content-start justify-content-lg-end justify-content-xl-end justify-content-xxl-end">
                                            <Button
                                                variant="warning"
                                                size="sm"
                                                className="me-2"
                                                onClick={() =>
                                                    navigateTpProfile(
                                                        firmType === "1" ? "my-team/details/" + item.user_slug
                                            ...
                                            {user_primary_role === "2" ? (
                                                <Link to={firmType === "1" ? "my-team/edit-resource/" + item.user_slug
